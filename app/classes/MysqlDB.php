...
/**
 * Generic MySQL Class
 * @author Gerrit Storm, gst@netuse.de
 * Diese Klasse wurde im Rahmen anderer Projekte erstellt und wird hier nur wiederverwendet.
 * Es werden hier nur wenige Funktionen der Klasse genutzt.
 */
