...
<div
	...
	<?php if (isset($displayData['imgdetails'])) foreach ($displayData['images'] as $key => $img){?>
	...
	<div class="imagearea">
		<a name="<?php echo $img->id ?>">
			...
			<div class="image">
				<a href="<?php echo $img->imgLink ?>"> <img
					src="<?php echo $img->thumbnail ?>">
				</a>
			</div>
			<div class="imagetext">
