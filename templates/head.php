<!-- @autor: Beate Gericke, Gerrit Storm, Maike Schröder, Thies Schillhorn -->

<!doctype html>
<html lang="de">
    <head>
        <meta charset="UTF-8">
        <title> <?php echo $conf->title ?> </title> <!-- hier muss noch eine Variale eingearbeitet werden, damit immer der Titel der aktuellen Seite angezeigt wird ToDo: Beate -->
